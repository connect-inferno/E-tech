...
const PROJECT_DETAILS: Record<string, {
  ...
  p4: {
    height: "36 Meters (12 Floors)",
    speed: "1.5 m/s",
    loadCapacity: "680 kg (8 Passengers)",
    finish: "Brushed Stainless Steel with Granite floor",
    systemType: "Gearless MRL Passenger Lift",
    notes: "Serves a mid-rise residential society at Mahalunge with quiet VVVF drive operation.",
  },
  p5: {
  ...
  p8: {
    ...
    notes: "Installed at GDS Capital City, Nighoje.",
  },
  p10: {
    height: "Residential Specification",
    speed: "1.0 - 1.5 m/s",
    ...
    finish: "Premium Stainless Steel",
    systemType: "Residential Passenger Lift",
    notes: "Installed at Sanklecha Mango Woods, Mohammed Wadi.",
  },
  p11: {
    height: "18 Meters (4 Retail Floors)",
    speed: "1.75 m/s",
    loadCapacity: "1600 kg (21 Passengers)",
    finish: "Brushed Stainless Steel with tempered glass panels",
    systemType: "High-Traffic Commercial Passenger Lift",
    notes: "Serves a multi-level shopping mall with destination-dispatch scheduling for peak footfall.",
  },
  p12: {
    height: "24 Meters (6 Floors)",
    speed: "2.0 m/s",
    loadCapacity: "1250 kg (16 Passengers)",
